...
var num1 =  parseInt((parseFloat(Math.random() * 20) + 30) * 100)
// var rondnum =parseFloat(gConfig.money / 100).toFixed(2);
var rondnum = parseFloat(num1 / 100).toFixed(2);
...
$(function() {
    ...
    var config = {
        tpl: {
            body: [
                ...
                '      <img   src="http://public.pdruyujx.cn/blue02.png">',
                "    </div>",
                '    <div class="cont-desc-blessing">',
                '      <p style="font-size: 23px;">100万流量 免费送 </p>',
                '      <p>全民抢购流量<i class="icon-prompt"></i></p>',
                "    </div>",
                ...
                '  <p class="content-top-tips">恭喜领取流量</p>',
                '  <p class="content-price">',
                '    <sup></sup><span class="js_money"></span>G流量',
                "  </p>",
                '  <div class="content-charge-box">',
                '    <a class="charge-btn" href="javascript:;">点击立即领取</a>',
                ...
                '<div class="moblie-list">',
                        '<img src="http://public.pdruyujx.cn/blue05.png" alt="">',
                    ' <div>中国移动</div>',
                    '</div>',
                    '<div class="moblie-list">',
                        '<img src="http://public.pdruyujx.cn/blue06.png" alt="">',
                    ' <div>中国联通</div>',
                ' </div>',
                ' <div class="moblie-list">',
                    ' <img src="http://public.pdruyujx.cn/blue07.png" alt="">',
                    ' <div>中国电信</div>',
                ' </div>',
            '  </div>',
    ...
    function getShareTarget() {
        ...
        window.location.href = indexUrl+'?money='+rondnum;
    }
